...
| Glama — Connector | 2026-09-07 | approved, live; ownership claim pending | glama.ai/mcp/connectors (AlexCredit — Kazakhstan Microfinance Catalog) | approval e-mail received 2026-09-07; claim via DNS TXT or HTTP ownership token (keep the record/file in place — Glama re-verifies) |
