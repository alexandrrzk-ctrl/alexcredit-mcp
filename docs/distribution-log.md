...
| Glama | 2026-09-07 | owner adds manually | expected https://glama.ai/mcp/servers/alexandrrzk-ctrl/alexcredit-mcp | add via «Add server» with the GitHub repo URL (as done for mfoxa), then claim; badge unlocks the awesome-mcp-servers PR |
