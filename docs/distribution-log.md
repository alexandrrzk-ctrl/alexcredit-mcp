...
| Glama | 2026-09-07 | submitted for review (Server + Connector) | expected https://glama.ai/mcp/servers/alexandrrzk-ctrl/alexcredit-mcp | submitted by the owner via «Add MCP Server»: Server tab with the repo URL and Connector tab with the endpoint; after approval — claim; badge unlocks the awesome-mcp-servers PR |
