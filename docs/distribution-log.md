...
| Glama — Connector | 2026-09-07 | live, ownership verified | https://glama.ai/mcp/connectors/kz.alexcredit/alex-credit-kazakhstan-microfinance-catalog | approval e-mail received 2026-09-07; ownership claim via HTTP token: https://alexcredit.kz/.well-known/glama.json published (served by nginx, file tracked in the frontend repo) — never delete, Glama re-verifies periodically; ownership verified 2026-09-07 |
