...
| Glama — Connector | 2026-09-07 | approved, live; ownership claim pending | https://glama.ai/mcp/connectors/kz.alexcredit/alex-credit-kazakhstan-microfinance-catalog | approval e-mail received 2026-09-07; ownership claim via HTTP token: https://alexcredit.kz/.well-known/glama.json published (served by nginx, file tracked in the frontend repo) — never delete, Glama re-verifies periodically; confirm verification in the Glama claim panel |
| Glama — Server (GitHub repo) | — | to submit | expected https://glama.ai/mcp/servers/alexandrrzk-ctrl/alexcredit-mcp | Server tab with the repo URL; produces the score badge required by the awesome-mcp-servers bot |
